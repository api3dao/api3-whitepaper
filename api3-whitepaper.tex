...
Successful governance---successfully monetizing dAPIs while avoiding mistakes that may result in paying out service coverage claims---will be rewarded in API3 tokens, which will create a positive feedback loop that will continually improve governance.
...
One of the main reasons of this is that insurance naturally requires a centralized third party to resolve insurance disputes, and using a mutually-trusted third party for this purpose is against the ethos of decentralization.
...
\href{https://github.com/api3dao/api3-whitepaper/releases/tag/v1.0.3}{v1.0.3} -- Burak Benligiray, Erich Dylus, June 2022.
